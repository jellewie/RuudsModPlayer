# RuudsModPlayer
Amiga Module sound file player.
...
- Outputs in stereo to the soundcard using a sample rate you can specify (changeable only when no song is currently playing);
